...
namespace Engine
{
    ...
    void LoaderGLTF::decodeImages(JobSystem& jobSystem, fastgltf::Asset& asset, const std::filesystem::path& assetDir,
                                  ParsedGLTF& outData)
    {
    ...
    void LoaderGLTF::extractMaterials(fastgltf::Asset& asset, ParsedGLTF& outData)
    {
        ...
        for (auto& mat : asset.materials)
        {
            ...
            cpuMat.emissiveFactor = glm::vec4(mat.emissiveFactor[0], mat.emissiveFactor[1], mat.emissiveFactor[2],
                                              0.0f);
        ...
        for (std::size_t i = 0; i < asset.nodes.size(); ++i)
        {
            ...
            std::visit(fastgltf::visitor{
                           [&](const fastgltf::math::fmat4x4& matrix)
                           {
                               ...
                               glm::decompose(bakedMatrix, parsedNode.transform.scale, parsedNode.transform.rotation,
                                              parsedNode.transform.translation, skew, perspective);
                           },
            ...
            if (gltfNode.meshIndex.has_value())
            {
                ...
                for (auto& prim : mesh.primitives)
                {
                    ...
                    parsedPrim.localMaterialIndex = prim.materialIndex.has_value()
                                                        ? static_cast<uint32_t>(prim.materialIndex.value()) + 1
                                                        : 0;
