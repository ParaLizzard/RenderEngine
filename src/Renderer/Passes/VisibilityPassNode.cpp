...
namespace Engine {
    VisibilityPassNode::VisibilityPassNode(VulkanDevice &device,
                                           Renderer &renderer,
                                           Model &megaBuffer,
    ...
    void VisibilityPassNode::createMeshPipeline()
    {
        ...
        vkCreateGraphicsPipelines(
            device.GetHandle(), device.getPipelineCache(), 1, &pipelineInfo, VK_NULL_HANDLE, &meshPipeline);
    ...
    void VisibilityPassNode::createMaskedPipeline()
    {
        ...
        ENGINE_VERIFY(vkCreatePipelineLayout(device.GetHandle(), &pipelineLayoutInfo, nullptr, &maskedPipelineLayout) == VK_SUCCESS,
        ...
        VkShaderModule vertModule = ShaderUtils::createShaderModule(device.GetHandle(), vertCode);
        VkShaderModule fragModule = ShaderUtils::createShaderModule(device.GetHandle(), fragCode);
        ...
        ENGINE_VERIFY(vkCreateGraphicsPipelines(device.GetHandle(), device.getPipelineCache(), 1, &pipelineInfo, nullptr, &maskedPipeline) == VK_SUCCESS,
            "VisibilityPassNode: failed to create masked pipeline");

        vkDestroyShaderModule(device.GetHandle(), vertModule, nullptr);
